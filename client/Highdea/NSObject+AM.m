...
#define kAMPropertyPattern @"^(?:(?:setPrimitive|set)([A-Z][^:]*):|(?:primitive|getPrimitive|get)([A-Z][^:]*)|([a-z]+[^:]*))$"
...
+ (NSString*) extractPropertyName:(NSString*)from {
    NSString* found = [from match:kAMPropertyPattern];
...
+ (char) encodedPropertyType:(NSString*)propertyName {
    ...
    return attrs == nil ? AMPropertyTypeUnknown : attrs[1];
}
+ (BOOL) isObjectProperty:(NSString*)property { return [self encodedPropertyType:property] == AMPropertyTypeObject; }
...
+ (NSString*) decodePropertyType:(const char*)attrs {
    ...
    switch (attrs[1]) {
        case AMPropertyTypeChar:             return @"char";
        case AMPropertyTypeInt:              return @"int";
        case AMPropertyTypeShort:            return @"short";
        case AMPropertyTypeLong:             return @"long";
        case AMPropertyTypeLongLong:         return @"long long";
        case AMPropertyTypeUnsignedChar:     return @"unsigned char";
        case AMPropertyTypeUnsignedInt:      return @"unsigned int";
        case AMPropertyTypeUnsignedShort:    return @"unsigned short";
        case AMPropertyTypeUnsignedLong:     return @"unsigned long";
        case AMPropertyTypeUnsignedLongLong: return @"unsigned long long";
        case AMPropertyTypeFloat:            return @"float";
        case AMPropertyTypeDouble:           return @"double";
        case AMPropertyTypeBool:             return @"bool";
        case AMPropertyTypeVoid:             return @"void";
        case AMPropertyTypeCString:          return @"char *";
        case AMPropertyTypeClass:            return @"Class";
        case AMPropertyTypeSelector:         return @"SEL";
        case AMPropertyTypeCArray:           return @"carray";
        case AMPropertyTypeStruct:           return @"struct";
        case AMPropertyTypeUnion:            return @"union";
        case AMPropertyTypeBitfield:         return @"bitfield";
        case AMPropertyTypePointer:          return [NSString stringWithFormat:@"%@*", [self decodePropertyType:++attrs]];
        case AMPropertyTypeUnknown:          return @"unknown";
    }
